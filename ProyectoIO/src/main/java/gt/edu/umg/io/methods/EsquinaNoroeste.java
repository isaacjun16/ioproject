...
public class EsquinaNoroeste {
	...
	private static final Logger log = Logger.getLogger(EsquinaNoroeste.class.getName());
	...
	public static TransporteResponse resolver(TransporteRequest data) {
		...
		try {
			...
			do {
				...
				System.out.println("Costo esquina noroeste en[" + x + "][" + y + "]: " + data.getPrecios()[x][y]);
